...
new OpenLayers.Control.Permalink('maxi', 'http://latlon.org/maxi'),
      ...
      var pt = new OpenLayers.Layer.TMS("Places without roads", "http://a.tile.osmosnimki.ru/lonelyplaces/", {   isBaseLayer: false,  type: 'png', getURL: osmu_getTileURL, displayOutsideMaxExtent: true, visibility: true });
