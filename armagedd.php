...
new OpenLayers.Control.Permalink('maxi', 'http://latlon.org/maxi'),
      ...
      var pt = new OpenLayers.Layer.TMS("Armagedd", "http://osm.kosmosnimki.ru/armagedd/", {   isBaseLayer: false,  type: 'png', getURL: osmu_getTileURL, displayOutsideMaxExtent: true, visibility: true });
