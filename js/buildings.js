...
function init() {
    ...
    buildings = new OpenLayers.Layer.OSM("Buildings", "http://e.tile.osmosnimki.ru/buildings/${z}/${x}/${y}.png", {isBaseLayer: false,  type: 'png', displayOutsideMaxExtent: true, transitionEffect: "resize", visibility: true});


    map.addLayers([mapnik, /* bel,*/ buildings]);
