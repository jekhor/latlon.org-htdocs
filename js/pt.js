...
function init() {
    ...
    pt = new OpenLayers.Layer.OSM("Public Transport (World)", "http://e.tile.osmosnimki.ru/pt/${z}/${x}/${y}.png", {isBaseLayer: false,  type: 'png', displayOutsideMaxExtent: true, transitionEffect: "resize", visibility: true});
